...
(0, vitest_1.describe)("Ticket A5 - Complex Tie-Breakers", () => {
    (0, vitest_1.it)("Flush vs Flush (High Card)", () => {
        // P1: Ah 9h
        // P2: Kh Qh
    ...
    (0, vitest_1.it)("Flush vs Flush (Kicker)", () => {
        // P1: Ah 9h
        // P2: Ah 8h
        // Board: 2h 4h 6h 8c 9d
        // P1: Ah 9h 6h 4h 2h
    ...
    (0, vitest_1.it)("Straight vs Straight (High End)", () => {
        // P1: T 9
        // P2: 6 5
        // Board: 7 8 A K 2
    ...
    (0, vitest_1.it)("Counterfeited Two Pair (Split)", () => {
        // P1: 3 3
        // P2: 2 2
        // Board: A A K K Q
    ...
    (0, vitest_1.it)("Counterfeited Two Pair (Kicker Plays)", () => {
        // P1: Q Q
        // P2: J J
        // Board: A A K K 5
    ...
    (0, vitest_1.it)("Four of a Kind Kicker", () => {
        // P1: K 2
        // P2: K 3
        // Board: A A A A 5
        // P1: A A A A K
    ...
    (0, vitest_1.it)("Four of a Kind Kicker (Winner)", () => {
        // P1: K 2
        // P2: Q 3
        // Board: A A A A 5
        // P1: A A A A K
