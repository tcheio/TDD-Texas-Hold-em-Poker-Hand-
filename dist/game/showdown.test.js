...
function parseCards(input) {
    return input.map(parser_1.parseCard);
}
(0, vitest_1.describe)("Ticket A4 - Compare Players", () => {
    (0, vitest_1.it)("Player 1 wins with Higher Pair", () => {
        // P1: AA, P2: KK, Board: 2 3 4 5 9
        const p1 = parseCards(["Ah", "Ad"]);
        const p2 = parseCards(["Kh", "Kd"]);
        const board = parseCards(["2s", "3c", "4h", "5d", "9s"]);
        (0, vitest_1.expect)((0, showdown_1.comparePlayers)(p1, p2, board)).toBe(showdown_1.Winner.Player1);
    });
    (0, vitest_1.it)("Player 2 wins with Flush vs Straight", () => {
        ...
        (0, vitest_1.expect)((0, showdown_1.comparePlayers)(p1, p2, board)).toBe(showdown_1.Winner.Player2);
    });
    (0, vitest_1.it)("Split pot (same hand)", () => {
        ...
        (0, vitest_1.expect)((0, showdown_1.comparePlayers)(p1, p2, board)).toBe(showdown_1.Winner.Split);
    });
    (0, vitest_1.it)("Split pot (same pair, same kickers)", () => {
        // P1: A 2
        // P2: A 3
        // Board: K K Q J 9
        // P1: K K A Q J
    ...
    (0, vitest_1.it)("Player 1 wins by kicker", () => {
        // P1: A 9
        // P2: A 8
        // Board: K K Q J 7
        // P1: K K A Q J (Best 5)
